...
<font color=red>I've since realized I was trying to import the wrong file: instead of importing the .py files I should have been using the compiled binaries (.pyc files) in ```site-packages/__pycache__```.</font>
